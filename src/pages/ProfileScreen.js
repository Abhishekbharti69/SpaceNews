  ...
  return (
    <SafeAreaView style={styles.container}>
      <Appbar.Header style={{ backgroundColor: COLORS.TAB_ACTIVE_COLOR }}>
        <Appbar.Content titleStyle={{ color: "white" }} title="About" />
      </Appbar.Header>
      <View style={styles.profileContainer}>
        <TouchableOpacity onPress={pickImage}>
          {profileImage ? (
            ...
            <Avatar.Icon
              style={{ backgroundColor: COLORS.TAB_ACTIVE_COLOR }}
              size={200}
              icon="camera"
            />
          )}
        ...
        <View style={{ marginTop: 20, alignItems: "center" }}>
          ...
          <Text style={{ color: "blue" }}>kama123jit@gmail.com</Text>
          <Text style={{ color: "blue" }}>avshekbharti@gmail.com</Text>
          <Text style={{ color: "blue" }}>singhhasandeep22@gmail.com</Text>
        </View>
        <View style={{ marginTop: 20, alignItems: "center" }}>
